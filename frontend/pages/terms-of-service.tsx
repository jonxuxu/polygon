const Privacy = () => (
  <div style={{ padding: "3rem" }}>
    ...
    <p>
      ...
      of Polygon's Website.
    </p>{" "}
    <br />
    <span>Polygon Video</span> is located at:1255 Grove St, San Francisco, CA
    94117
    <br />
    <address>
      <br />
    ...
    <p>
      ...
      in full. Do not continue to use On Deck's website if you do not accept all
    ...
    <h2>Cookies</h2>
    <p>
      We employ the use of cookies. By using Polygon's website you consent to
      the use of cookies in accordance with Polygon's privacy policy.
    </p>
    <p>
    ...
    <p>
      ...
      visibility associated with the hyperlink outweighs the absence of Polygon;
    ...
    <p>
      ...
      e-mail to{" "}
      <a
        href="mailto:info@beondeck.com"
        title="send an email to info@beondeck.com"
      >
        info@beondeck.com
      </a>
    ...
    <p>
      No use of Polygon's logo or other artwork will be allowed for linking
